...
import { 
  Zap, Ruler, Shield, Flame, Gem, Factory, 
  Wrench, CheckCircle2, Truck, ArrowRight, FileText, HelpCircle, Sparkles
} from "lucide-react";

export default function SheetBending() {
    ...
    <>
      ...
      <section className="py-20 md:py-28 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            >
              {t("bending.cta_calc")} <ArrowRight className="w-6 h-6 group-hover:translate-x-2 transition" />
            </button>
      ...
      <section className="py-16">
        <div className="max-w-4xl mx-auto px-6 grid grid-cols-2 md:grid-cols-4 gap-6">
          {[
            { icon: <Flame className="w-10 h-10 text-red-400" />, v: "20 mm", m: t("bending.thickness.steel") },
            { icon: <Gem className="w-10 h-10 text-blue-400" />, v: "15 mm", m: t("bending.thickness.stainless") },
            { icon: <Sparkles className="w-10 h-10 text-orange-400" />, v: "12 mm", m: t("bending.thickness.aluminum") },
            { icon: <Ruler className="w-10 h-10 text-cyan-400" />, v: "6 m", m: t("bending.thickness.length") },
          ].map((item, i) => (
      ...
      <section className="py-16 bg-black/30">
        <div className="max-w-5xl mx-auto px-6 grid grid-cols-2 md:grid-cols-3 gap-8">
          {[
            { i: <CheckCircle2 className="w-10 h-10 text-green-400" />, t: t("bending.advantages.precision") },
            { i: <Factory className="w-10 h-10 text-indigo-400" />, t: t("bending.advantages.equipment") },
            { i: <Wrench className="w-10 h-10 text-purple-400" />, t: t("bending.advantages.complex") },
            { i: <Zap className="w-10 h-10 text-yellow-400" />, t: t("bending.advantages.fast") },
            { i: <Shield className="w-10 h-10 text-cyan-400" />, t: t("bending.advantages.quality") },
            { i: <Truck className="w-10 h-10 text-pink-400" />, t: t("bending.advantages.delivery") },
          ].map((item, i) => (
      ...
      <section className="py-16">
        <div className="max-w-3xl mx-auto px-6 space-y-4">
          {[
            { q: t("bending.faq.complex"), a: t("bending.faq.complex_answer") },
            { q: t("bending.faq.time"), a: t("bending.faq.time_answer") },
            { q: t("bending.faq.delivery"), a: t("bending.faq.delivery_answer") },
          ].map((faq, i) => (
