...
import { 
  Zap, Ruler, Shield, Clock4, Flame, Gem, Factory, 
    ...
    <>
      ...
      <section className="py-20 md:py-28 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <div className="flex justify-center gap-8 mb-10 text-5xl">
            ...
            <Clock4 className="text-pink-400" />
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            >
              {t("laser.cta_calc")} <ArrowRight className="w-6 h-6 group-hover:translate-x-2 transition" />
            </button>
      ...
      <section className="py-16">
        <div className="max-w-4xl mx-auto px-6 grid grid-cols-2 md:grid-cols-4 gap-6">
          {[
            { icon: <Flame className="w-10 h-10 text-red-400" />, v: "25 mm", m: t("laser.thickness.steel") },
            { icon: <Factory className="w-10 h-10 text-gray-400" />, v: "20 mm", m: t("laser.thickness.stainless") },
            { icon: <Gem className="w-10 h-10 text-blue-400" />, v: "15 mm", m: t("laser.thickness.aluminum") },
            { icon: <Sparkles className="w-10 h-10 text-orange-400" />, v: "10 mm", m: t("laser.thickness.copper") },
          ].map((item, i) => (
      ...
      <section className="py-16 bg-black/30">
        <div className="max-w-5xl mx-auto px-6 grid grid-cols-2 md:grid-cols-3 gap-8">
          {[
            { i: <CheckCircle2 className="w-10 h-10 text-green-400" />, t: t("laser.advantages.ready") },
            { i: <Factory className="w-10 h-10 text-indigo-400" />, t: t("laser.advantages.equipment") },
            { i: <Wrench className="w-10 h-10 text-purple-400" />, t: t("laser.advantages.free_drawing") },
            { i: <Zap className="w-10 h-10 text-yellow-400" />, t: t("laser.advantages.fast") },
            { i: <Shield className="w-10 h-10 text-cyan-400" />, t: t("laser.advantages.warranty") },
            { i: <Truck className="w-10 h-10 text-pink-400" />, t: t("laser.advantages.delivery") },
          ].map((item, i) => (
      ...
      <section className="py-16">
        <div className="max-w-3xl mx-auto px-6 space-y-4">
          {[
            { q: t("laser.faq.no_dxf"), a: t("laser.faq.no_dxf_answer") },
            { q: t("laser.faq.time"), a: t("laser.faq.time_answer") },
            { q: t("laser.faq.delivery"), a: t("laser.faq.delivery_answer") },
          ].map((faq, i) => (
